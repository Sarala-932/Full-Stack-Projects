...
export default function BudgetProgress({initialBudget, currentExpenses, onUpdate}) {
  const [isEditing, setIsEditing] = useState(false);
  const [newBudget, setNewBudget] = useState(initialBudget?.amount?.toString() || "");

  // Sync newBudget state if initialBudget changes from parent
  useEffect(() => {
  ...
  const rawPercentage = initialBudget
