...
function CardHeader({
  ...
  return (
    <div
      ...
      className={cn(
        "group/card-header @container/card-header grid auto-rows-min items-start gap-1 rounded-t-xl px-3 group-data-[size=sm]/card:px-2 has-data-[slot=card-action]:grid-cols-[1fr_auto] has-data-[slot=card-description]:grid-rows-[auto_auto] [.border-b]:pb-3 group-data-[size=sm]/card:[.border-b]:pb-2",
        className
      )}
      {...props} />
  );
...
function CardFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "flex rounded-b-xl p-3 group-data-[size=sm]/card:p-2",
        className
      )}
      {...props} />
  );
